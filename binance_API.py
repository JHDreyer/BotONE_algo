...
api_key = 'AqHxypUTUULqCexBbVsvk0EFGEesI5TbRdXnOzd9X2tAZ6rkrt0lmr5ZA5zwlzGN'
api_secret = 'gzE7eMdh7xTB9Gl2jSrBFfY5jGh0nDaZhVfySO9ld7RxXnnrSOh1EsNGebk1MKDn'
...
def update_data_binance(df_ohlc, str_name_binance):
    ...
    df_ohlc_updated =  df_ohlc_updated.iloc[-780:] # make df smaller faster processing
